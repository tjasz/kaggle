...
dataset <- subset(origdata, select=c("Survived","Pclass","Sex","Age","SibSp","Parch","Fare","Embarked"))
# TODO include numeric transformations of other columns?
...
numeric.cols <- unlist(lapply(dataset, is.numeric))
